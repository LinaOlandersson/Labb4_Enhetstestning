...
namespace Labb4_Enhetstestning
{
    public class LibrarySystem
    {
        ...
        public LibrarySystem()
        {
            ...
            books.Add(new Book("Träd", "Gunnar Westerberg", "mmm123", 2004));
        }

        public bool AddBook(Book book)
        {
            if (book.ISBN != null && !books.Any(b => b.ISBN == book.ISBN))
            {
                books.Add(book);
                return true;
            }
        ...
        public List<Book> SearchManyByISBN(string isbn)
        {
            return books.Where(b => b.ISBN.Contains(isbn, StringComparison.OrdinalIgnoreCase)).ToList();
        }
